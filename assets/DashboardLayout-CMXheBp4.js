import{e as _,f,aj as p,r as w,az as x,q as r,ae as l,ay as h,al as m,x as e,ap as g,an as k,ao as v,t as y,F as C,ak as A,y as V,v as E,aA as L,R as $}from"./index-cHNbZU0U.js";import{_ as B}from"./Dashboard-BSgRqTYu.js";import{V as I,f as M}from"./VBtn-CGgUiJ1g.js";import{V as z}from"./VMain-RT2aQvlj.js";import"./color-BnFqK9M4.js";import"./ssrBoot-BXLf59t8.js";class D extends HTMLElement{static get observedAttributes(){return["gap"]}constructor(){super(),this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
        display: grid;
