import{q as _,L as w,M as c,r as x,Z as v,P as a,Q as l,R as m,_ as h,T as e,S as g,m as y,U as b,F as k,V as C,W as V,a as A,$}from"./index-B1v3YosH.js";import{V as E}from"./VBtn-8FXS4YpI.js";import{V as L}from"./index-B59mYeyW.js";import{V as B}from"./VMain-DhipIuWB.js";import"./color-C3NoHZil.js";import"./dimensions-D67XcnKL.js";import"./ssrBoot-bot6O20Z.js";class M extends HTMLElement{static get observedAttributes(){return["gap"]}constructor(){super(),this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
        display: grid;
