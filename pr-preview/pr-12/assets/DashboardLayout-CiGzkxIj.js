import{i as f,e as w,x,L as k,o as r,y as d,z as p,E as h,h as t,A as g,B as v,C,f as m,F as A,D as E,g as y,n as L,J as B}from"./index-Bj7p2MUf.js";import{u as b,V}from"./VMain-B2mdayxH.js";import{_ as $}from"./Dashboard-CgD1AF5O.js";import{V as D,a as I}from"./ssrBoot-Bo8zFda3.js";import"./color-TMnpNlyU.js";class M extends HTMLElement{static get observedAttributes(){return["gap"]}constructor(){super(),this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
        display: grid;
